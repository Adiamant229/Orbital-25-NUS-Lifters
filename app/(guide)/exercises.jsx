//react imports
import {StyleSheet, Image, ScrollView, FlatList, View, Pressable} from 'react-native';
...
const Exercises = () => {
    ...
    const searchName = (x) => {
        ...
        response.then(res => res.json()).then(res => setSearchRes(res)).then(() => console.log(searchRes));
    }
    ...
    return (
            <ThemedView style={styles.container}>
                ...
                <FlatList style={{flex:1}} data={searchRes} renderItem={({item}) => {
                    return (
                    <>
                        <Pressable onPress={() => {
                            router.push({pathname:"/exerciseInfo", params: {
                                name: item?.name,
                                id:item?.id,
                                ...
                                instructions:encodeURIComponent(JSON.stringify(item?.instructions)),
                            }});
                        }}>
